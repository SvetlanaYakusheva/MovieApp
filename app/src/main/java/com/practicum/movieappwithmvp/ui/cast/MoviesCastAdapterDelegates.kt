...
import com.practicum.movieappwithmvp.databinding.ListItemCastBinding
import com.practicum.movieappwithmvp.databinding.ListItemHeaderBinding
...
fun movieCastHeaderDelegate() =
    adapterDelegateViewBinding<MoviesCastRVItem.HeaderItem,
                                RVItem,
                                ListItemHeaderBinding
                                >(
    { layoutInflater, root -> ListItemHeaderBinding.inflate(layoutInflater,
                                                            root,
                                                false) }
) {
    bind {
